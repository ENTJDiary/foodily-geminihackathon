...
const DailyLogModal: React.FC<DailyLogModalProps> = ({ isOpen, onClose, entry, onSave, dayEntries, onSelectEntry, onAddNew, currentDateStr, onDelete }) => {
                    ...
                    <div className="p-6 border-t border-slate-100 bg-slate-50">
                        ...
                        {onDelete && entry.id && (
                            <button
                                ...
                                className="w-full mt-3 text-slate-400 hover:text-red-500 font-bold py-2 rounded-xl transition-all uppercase tracking-widest text-[10px] flex items-center justify-center gap-2"
                            >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
                                Delete Log
                            </button>
